...
![impression month]({{site.baseurl}}/assets/img/NCM/2_1_impr_month.png){:height="250px" width="900px"}
![impression day]({{site.baseurl}}/assets/img/NCM/2_1_impr_day.png){:height="250px" width="900px"}
...
![level distribution]({{site.baseurl}}/assets/img/NCM/2_2_level.png){:height="250px" width="400px"}
...
![top 10 user]({{site.baseurl}}/assets/img/NCM/2_2_top10user.png){:height="300px" width="900px"}
...
![location]({{site.baseurl}}/assets/img/NCM/2_3_location.png){:height="300px" width="900px"}
...
As we can find in the following pie charts, male users represents a larger proportion in active users than female users and the percentage of female users in inactive users is higher than that in active users. Hence, we can loosely infer that the application may be more appealing to the male users than to the female users.

![gender]({{site.baseurl}}/assets/img/NCM/2_3_gender.png){:height="300px" width="900px"}
...
![age]({{site.baseurl}}/assets/img/NCM/2_3_age.png){:height="250px" width="900px"}
...
![gender and age]({{site.baseurl}}/assets/img/NCM/2_3_gender_age.png){:height="400px" width="900px"}
