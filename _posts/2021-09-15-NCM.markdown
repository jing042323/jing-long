...
- Models to predict user activity, including Logistic Regression, SVM, Decision Tree and Neural Networks.  
...
### <span style="border-bottom:2px solid Coral;"> About NCM </span>
...
### <span style="border-bottom:2px solid Coral;"> The Data </span>
...
### <span style="border-bottom:2px solid Coral;"> Our Goals </span>
...
### <span style="border-bottom:2px solid Coral;"> 2.1 Usage Scenarios </span>
...
### <span style="border-bottom:2px solid Coral;"> 2.2 User Activity Intensity </span>
...
### <span style="border-bottom:2px solid Coral;"> 2.3 User Demographics </span>
...
### <span style="border-bottom:2px solid Coral;"> 2.4 User Behavior and Preferences </span>
...
#### <span style="border-bottom:2px solid Coral;"> In conclusion, our key findings from the data exploration are:  </span>
...
### <span style="border-bottom:2px solid Coral;"> 2.5 Models to Predict User Activity Level from Initial Actions </span>
...
Hence, the goal of our predictive model is a binary classification of users into future active or future inactive based on the initial 10 days of data, with our class of interest being future active users and our goal being achieving the highest possible accuracy in this prediction. Common machine learning models for binary classification are Logistic Regression and Support Vector Machines (SVM), and hence they are our first choices to test out. We also look at Decision Trees (DT) as they are purportedly apt for general classification problems, and Neural Networks (NN) as they can result in high levels of accuracy but at the cost of interpretability.
...
(iii) C (inverse of regularization strength):  
