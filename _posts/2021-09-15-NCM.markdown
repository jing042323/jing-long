...
- Followed (posts from the followed accounts)
...
- Karaoke Room \- shows two vertical streams of individual rooms for social acitivities such as chatting, singing, and even studying. Users can join the existing rooms or create their own rooms.
