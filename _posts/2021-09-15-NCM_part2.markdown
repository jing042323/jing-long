...
The code for this section is available here: [Appendix II](https://github.com/jing042323/Case-Study/tree/main/NCM/Appendix_II_Activity_Intensity_Prediction.html).
...
## <span style="color:Coral"> 3.6 Final Activity Prediction Model & Results </span>  
